...
from .views import admin_list_all_comments, create_comment, delete_my_comment, edit_my_comment, get_comment_by_id, list_comments_by_movie, admin_delete_comment, list_my_comments
...
urlpatterns = [
    ...
    path('admin/', admin_list_all_comments, name='admin-list-all-comments'),
